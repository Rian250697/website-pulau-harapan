...
<head>
  ...
  <title>Login &mdash; Dashboard Admin</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Login - Dashboard Admin</h4></div>
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" tabindex="1" required="required" autofocus="autofocus" autocomplete="email" value="{{ old('email') }}">
                    @error('email')
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" tabindex="2" required="required" autocomplete="current-password">
                    <div class="invalid-feedback">
